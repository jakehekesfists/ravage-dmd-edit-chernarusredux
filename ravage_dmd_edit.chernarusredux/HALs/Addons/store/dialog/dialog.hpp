	...
	class controls {
		class HALs_store_dialog: HALsStore_ctrlControlsGroupNoScrollbars {
			...
			class controls {
				...
				class ItemCheckbox4: HALsStore_ctrlCheckboxGreen {
					idc = IDC_RscDisplayStore_CHECKBOX4;
				...
				class SellButton: HALsStore_ctrlButton {
					idc = IDC_RscDisplayStore_BUTTON_SELL;
					x = 0.742137 * safezoneW + safezoneX;
					y = 0.555 * safezoneH + safezoneY;
					w = 0.0670312 * safezoneW;
					h = "1.2 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";//GRIDH(1); 
					...
					periodFocus = 1.2;
					periodOver = 1.2;
					text = "$STR_HALS_STORE_BUTTON_SELL";
					textSecondary = "";
					tooltip = "$STR_HALS_STORE_BUTTON_SELL";
					tooltipColorShade[] = {0,0,0,0.65};
					tooltipColorText[] = {1,1,1,1};
					tooltipColorBox[] = {0,0,0,0};
